...
class Args:
    ...
    """exploration method: none or rnd"""

    rnd_coef: float = 0.01
    """coefficient for RND intrinsic reward"""

    rnd_lr: float = 1e-4
    """learning rate for RND predictor"""

    rnd_feature_dim: int = 128
    """feature dimension for RND target and predictor networks"""
...
class RNDModel(nn.Module):
    ...
    def intrinsic_reward(self, obs):
        ...
        with torch.no_grad():
            ...
            reward = ((predicted_features - target_features) ** 2).mean(dim=1)
        return reward

    def loss(self, obs):
        predicted_features, target_features = self.forward(obs)
        return F.mse_loss(predicted_features, target_features.detach())
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for step in range(0, args.num_steps):
            ...
            if args.exploration == "rnd":
                ...
                intrinsic_rewards[step] = rnd_model.intrinsic_reward(next_obs_flat)
            else:
        ...
        with torch.no_grad():
            ...
            if args.exploration == "rnd":
                ...
                total_rewards = rewards + args.rnd_coef * norm_intrinsic_rewards
            else:
